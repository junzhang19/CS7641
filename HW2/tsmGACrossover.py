...
OUTPUT_FILE = 'tsm_result_GA_crossover.csv'

GA_POPULATION = 2000
GA_CROSSOVER_pool = [10,20,50,100,200,500,1000,2000]
GA_MUTATION = 250
...
with open(OUTPUT_FILE, "w") as outFile:
    for i in range(1):
        outFile.write(','.join([
            ...
            "ga_fitness",
            "ga_training_time"]) + '\n')
    for i in range(len(GA_CROSSOVER_pool)):
        outFile.write(','.join([
            str(GA_CROSSOVER_pool[i]),
